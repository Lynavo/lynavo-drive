...
function buildTargetStep(profile, target) {
  ...
  if (target === 'android') {
    return {
      ...
      args: [
        '-lc',
        `cd apps/mobile/android && ./gradlew assemble${capitalize(profile.market)}Release bundle${capitalize(profile.market)}Release -PreactNativeArchitectures=arm64-v8a,x86_64`,
      ],
    };
  }
  if (target === 'mac') {
