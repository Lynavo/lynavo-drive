...
const ALLOWED_EXACT_PATHS = new Map([
  ...
  ['apps/desktop/scripts/__tests__/package-linux.test.mjs', allowAny(NEGATIVE_ASSERTION_REASON)],
  ['apps/desktop/src/main/__tests__/diagnostics.test.ts', allowAny(NEGATIVE_ASSERTION_REASON)],
  ...
  ['packages/contracts/src/__tests__/exports.test.ts', allowAny(NEGATIVE_ASSERTION_REASON)],
  [
