...
| Support/update backend  | Desktop support/update network paths were removed; diagnostics now export a local archive only.                                                                         | Removed from OSS | Keep official support upload and update-check clients out of OSS.         |
